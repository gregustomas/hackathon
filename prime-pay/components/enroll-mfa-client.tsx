...
export function EnrollMfaClient() {
  ...
  const startEnrollment = async () => {
    ...
    // Supabase v data.totp.qr_code posílá přímo XML/SVG text!
      ...
      <CardContent>
        {isEnrolled ? (
          ...
          <div className="space-y-4">
            {" "}
            <div
              className="flex justify-center items-center bg-white mx-auto p-4 rounded-lg w-fit [&>svg]:w-48 [&>svg]:h-48"
